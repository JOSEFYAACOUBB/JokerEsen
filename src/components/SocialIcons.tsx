...
export const TiktokIcon: React.FC<{ className?: string }> = ({ className = "w-5 h-5" }) => (
  <svg className={className} viewBox="0 0 24 24" fill="currentColor">
    <path d="M19.59 6.69a4.83 4.83 0 0 1-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 1 1-5.2-1.74 2.89 2.89 0 0 1 2.31-2.88V7.55a6.34 6.34 0 0 0-5.11 6.16 6.34 6.34 0 1 0 11.45-3.64 8.27 8.27 0 0 0 3.77.94V7.69a4.83 4.83 0 0 1-.001-1z"/>
  </svg>
);
