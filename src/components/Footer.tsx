    ...
    <>
      <footer id="footer" className="w-full bg-[#F8FAFC] py-12 sm:py-16 px-4 sm:px-6 lg:px-8 text-center border-t border-slate-200">
        <div className="max-w-4xl mx-auto space-y-6 sm:space-y-8 flex flex-col items-center">
          ...
          >
            Fais bouger la vie étudiante avec <span className="text-[#A73541]">Joker</span><span className="text-[#4B5B9E]">Esen</span>
          </h2>
      ...
      <button
        ...
        className={`fixed bottom-6 right-6 z-40 flex items-center gap-2 px-4 py-3 rounded-full bg-[#A73541] text-white border border-[#A73541] text-xs font-black uppercase tracking-wider shadow-lg hover:bg-[#8B2C36] hover:scale-105 active:scale-95 transition-all duration-300 transform cursor-pointer group ${showScrollTop
            ? 'opacity-100 translate-y-0 pointer-events-auto shadow-[0_8px_24px_rgba(167,53,65,0.3)]'
            : 'opacity-0 translate-y-6 pointer-events-none'
          }`}
      >
        <span className="hidden sm:inline group-hover:tracking-widest transition-all">Haut de page</span>
        <span className="w-6 h-6 rounded-full bg-white/20 group-hover:bg-white text-white group-hover:text-[#A73541] flex items-center justify-center transition-colors">
