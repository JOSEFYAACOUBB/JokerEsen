    ...
    <>
      <footer className="w-full bg-[#F8FAFC] py-12 sm:py-16 px-4 sm:px-6 lg:px-8 text-center border-t border-slate-200">
        <div className="max-w-4xl mx-auto space-y-6 sm:space-y-8 flex flex-col items-center">
          ...
          {/* ── Joker ESEN Club Social Media Links ── */}
          <div className="flex flex-col items-center gap-2.5 pt-1">
            ...
            {/* Instagram */}
            <a
              href="https://www.instagram.com/joker.esen/"
              target="_blank"
            ...
            {/* Facebook */}
            <a
              href="https://www.facebook.com/joker.esen"
              target="_blank"
              rel="noopener noreferrer"
            ...
            {/* TikTok */}
            <a
              href="https://www.tiktok.com/@joker.esen"
              target="_blank"
              rel="noopener noreferrer"
            ...
            {/* Club LinkedIn */}
            <a
              href="https://www.linkedin.com/company/jokeresen"
              target="_blank"
              rel="noopener noreferrer"
